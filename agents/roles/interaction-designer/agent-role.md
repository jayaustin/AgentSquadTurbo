---
role_id: interaction-designer
display_name: Interaction Designer
...
- specify triggers transitions focus behavior motion intent and recovery paths instead of only end-state visuals
