---
role_id: security-architecture-reviewer
display_name: Security Architecture Reviewer
...
# Security Architecture Reviewer Role
...
- review control placement isolation boundaries auth context handling and data-flow assumptions in proposed designs
