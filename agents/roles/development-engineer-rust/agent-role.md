---
role_id: development-engineer-rust
display_name: Development Engineer Rust
...
# Development Engineer Rust Role
...
- use ownership and type design to encode invariants and isolate unsafe or FFI boundaries
...
- excessive cloning hidden blocking or unsafe escape hatches
