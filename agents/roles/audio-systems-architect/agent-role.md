---
role_id: audio-systems-architect
display_name: Audio Systems Architect
...
- define trigger systems middleware boundaries voice limits memory strategy and asset pipeline ownership together
- model cross-system dependencies degraded modes and ownership at every trust or availability boundary
