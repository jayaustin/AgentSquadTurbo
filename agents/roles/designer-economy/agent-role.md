---
role_id: designer-economy
display_name: Designer Economy
...
- model sources sinks scarcity pacing and exploit vectors directly in the design rather than leaving balance logic implicit
