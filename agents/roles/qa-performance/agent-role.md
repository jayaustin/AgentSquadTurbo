---
role_id: qa-performance
display_name: QA Performance
...
- measure against explicit baselines or budgets and capture the workload assumptions behind each conclusion
