---
role_id: security-compliance-engineer
display_name: Security Compliance Engineer
...
# Security Compliance Engineer Role
...
- map controls to requirements evidence sources control owners and exception paths instead of policy prose
