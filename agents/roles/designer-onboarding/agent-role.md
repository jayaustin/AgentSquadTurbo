---
role_id: designer-onboarding
display_name: Designer Onboarding
...
- prioritize the fastest path to first success progressive disclosure and clear recovery from early mistakes
