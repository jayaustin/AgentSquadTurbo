---
role_id: qa-penetration
display_name: QA Penetration
...
- exercise attack paths with clear scope control exact preconditions and evidence that separates exploitability from speculation
