---
role_id: development-engineer-database-nosql
display_name: Development Engineer Database NoSQL
...
# Development Engineer Database NoSQL Role
...
- treat durable data changes as rollout-sensitive work with explicit compatibility and recovery paths
