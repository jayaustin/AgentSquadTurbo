---
role_id: designer-platform-web
display_name: Designer Platform Web
...
- account for viewport changes pointer and keyboard use browser chrome loading expectations and trust signals
