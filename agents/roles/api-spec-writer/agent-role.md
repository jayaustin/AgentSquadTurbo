---
role_id: api-spec-writer
display_name: API Spec Writer
...
- define methods resources payload shape examples error envelopes auth pagination and idempotency explicitly
