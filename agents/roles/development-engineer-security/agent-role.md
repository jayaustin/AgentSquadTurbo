---
role_id: development-engineer-security
display_name: Development Engineer Security
...
# Development Engineer Security Role
...
- apply least privilege input validation dependency hygiene secret handling and explicit auth context checks
