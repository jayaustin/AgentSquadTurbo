---
role_id: security-engineer-devsecops
display_name: Security Engineer DevSecOps
...
# Security Engineer DevSecOps Role
...
- harden build identities artifact provenance dependency intake secret handling and gate enforcement in the pipeline
