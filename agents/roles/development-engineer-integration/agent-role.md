---
role_id: development-engineer-integration
display_name: Development Engineer Integration
...
# Development Engineer Integration Role
...
- define ownership mapping rules timeout or retry policy idempotency and degraded behavior at every boundary
