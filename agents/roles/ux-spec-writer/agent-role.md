---
role_id: ux-spec-writer
display_name: UX Spec Writer
...
- document primary empty loading success blocked and error states along with content and accessibility expectations
