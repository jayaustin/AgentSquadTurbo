---
role_id: security-cryptography-engineer
display_name: Security Cryptography Engineer
...
# Security Cryptography Engineer Role
...
- be explicit about algorithms modes nonces key lifecycle trust assumptions and interoperability constraints
