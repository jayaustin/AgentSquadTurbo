---
role_id: development-engineer-csharp
...
- use nullable annotations async patterns and allocation awareness honestly and keep framework glue away from core rules
