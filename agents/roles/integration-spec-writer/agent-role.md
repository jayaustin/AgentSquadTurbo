---
role_id: integration-spec-writer
display_name: Integration Spec Writer
...
- name producer and consumer ownership mapping rules timeouts retries idempotency and degraded-mode behavior
