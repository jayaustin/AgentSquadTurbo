---
role_id: qa-compatibility-mobile
display_name: QA Compatibility Mobile
...
- cover supported environment differences rather than assuming one browser device or runtime proves compatibility
