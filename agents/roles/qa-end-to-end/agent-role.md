---
role_id: qa-end-to-end
display_name: QA End-to-End
...
- cover the highest-value journeys across real integration points setup dependencies and degraded-mode behavior
