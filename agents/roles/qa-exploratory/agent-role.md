---
role_id: qa-exploratory
display_name: QA Exploratory
...
- use charters hypotheses and targeted note capture so exploration produces actionable signal instead of wandering
