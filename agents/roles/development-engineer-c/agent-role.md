---
role_id: development-engineer-c
display_name: Development Engineer C
...
- make memory ownership buffer limits error codes and cleanup explicit and test the edge conditions
...
- buffer misuse cleanup omissions or implicit contracts that only live in one head
