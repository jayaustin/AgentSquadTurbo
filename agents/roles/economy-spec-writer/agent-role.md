---
role_id: economy-spec-writer
display_name: Economy Spec Writer
...
- document sources sinks pricing formulas guardrails and abuse cases so balancing is grounded in explicit rules
