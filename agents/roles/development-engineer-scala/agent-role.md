---
role_id: development-engineer-scala
display_name: Development Engineer Scala
...
# Development Engineer Scala Role
...
- make effect boundaries type contracts and async behavior explicit enough for non-authors to maintain
