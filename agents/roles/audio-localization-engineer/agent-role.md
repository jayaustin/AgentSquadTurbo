---
role_id: audio-localization-engineer
display_name: Audio Localization Engineer
...
# Audio Localization Engineer Role
...
- account for subtitle timing dubbing or VO asset mapping pronunciation guides and platform-specific audio packaging
