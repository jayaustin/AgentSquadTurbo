---
role_id: designer-gameplay
display_name: Designer Gameplay
...
- specify rules feedback counterplay fail states and tuning surfaces so implementation can preserve intended feel
