---
role_id: security-analyst-threat-modeling
display_name: Security Analyst Threat Modeling
...
# Security Analyst Threat Modeling Role
...
- enumerate assets actors entry points trust boundaries likely abuse cases and the controls expected to stop them
