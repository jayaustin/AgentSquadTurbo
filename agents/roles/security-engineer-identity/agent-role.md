---
role_id: security-engineer-identity
display_name: Security Engineer Identity
...
# Security Engineer Identity Role
...
- model login session token provisioning deprovisioning and authorization behavior across success and abuse paths
