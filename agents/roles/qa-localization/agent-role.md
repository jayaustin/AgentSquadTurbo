---
role_id: qa-localization
display_name: QA Localization
...
- check placeholders truncation RTL font coverage locale formatting and fallback behavior with locale-specific evidence
