---
role_id: security-secrets-management-engineer
display_name: Security Secrets Management Engineer
...
# Security Secrets Management Engineer Role
...
- treat issuance storage access control rotation revocation and auditability as one lifecycle
